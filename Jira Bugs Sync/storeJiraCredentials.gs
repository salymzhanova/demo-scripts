function storeJiraCredentials() {
  ...
  PropertiesService.getScriptProperties().setProperties({
    "JIRA_BASE_URL": "https://your-domain.atlassian.net/", // Enter your actual Jira username here
    "JIRA_USERNAME": "your-username@attlassian.com", // Enter your actual Jira API token here
